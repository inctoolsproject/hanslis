...
➦[Link off]
➦[Link on]
➦[Cbroadcast「text broadcast」] Bc all contact
➦[Gbroadcast「text broadcast」] Bc all group
➦[Gurl]
➦[Sebut]
➦[R1-2-3 Tag]
➦[Protect「on/off」]
...
wait = {
    ...
    "lang":"JP",
    "comment":"Thanks for add me ヽ(^o^)v",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#===========================================
        ...
        if op.type == 25:
			...
			kc.sendText(msg.to,cmid)
                ...
                #ki.sendText(msg.to,"")
                #kk.sendText(msg.to,"")
            elif "All say " in msg.text:
				bctxt = msg.text.replace("All say ","")
...
#========================================
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n [☸]➦Powered By: メƦᴇᴄᴋʏ_₠ʙ∞η₲々•┅─────" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#========================================
            ...
            elif msg.text in ["Sepi tete","Pulang","otw all"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
     ...
     for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AutoLike by : メƦᴇᴄᴋʏ_₠ʙ∞η₲々•┅─────")
            ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"AutoLike by: メƦᴇᴄᴋʏ_₠ʙ∞η₲々•┅─────")
            print "Like"
          except:
            pass
        else:
